...
export default function ProcessRopeSteps() {
  return (
    <section className="bg-white py-24 px-6 sm:px-8 md:px-16 lg:px-24">
      ...
      <div className=" grid grid-cols-2 space-y-16 max-w-6xl mx-auto">
        {steps.map((step, index) => (
          <div key={index} className="flex items-start space-x-4">
            {/* Number Circle */}
            <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 font-bold text-lg shadow">
              {step.number}
            </div>
