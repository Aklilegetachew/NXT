        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="text-2xl md:text-4xl font-light mb-8 text-gray-600">
              <span className="text-gray-900">Trading</span> PLC
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className={`backdrop-blur-lg bg-white/80 rounded-2xl p-6 border border-gray-200 hover:border-[#341C1C] hover:bg-white hover:shadow-xl transition-all duration-300 transform hover:scale-105 ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-10"
                  }`}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <h2 className="text-5xl font-bold leading-tight text-gray-900">
                Building the{" "}
                <span style={{ color: "#341C1C" }}>Digital Future</span> of
                Ethiopia
              </h2>
            ...
            <div className="space-y-16">
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`backdrop-blur-lg bg-white/90 rounded-2xl p-8 border border-gray-200 hover:bg-white hover:border-[#341C1C] hover:shadow-xl transition-all duration-300 transform hover:scale-105 ${
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="group backdrop-blur-lg bg-white/90 rounded-2xl p-8 border border-gray-200 hover:bg-white hover:border-[#341C1C] hover:shadow-xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2"
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {service.tech.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-3 py-1 rounded-full text-xs text-gray-700 border"
                      style={{
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="group text-center p-8 backdrop-blur-lg bg-white/90 rounded-2xl border border-gray-200 hover:bg-white hover:border-[#341C1C] hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
                <div
                  className="w-20 h-20 mx-auto mb-6 rounded-2xl flex items-center justify-center border border-gray-200 group-hover:border-[#341C1C] transition-all duration-300 shadow-lg"
      ...
      >
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Link href="/contactus">
              <button className="px-10 py-5 border-2 border-white rounded-2xl font-bold text-lg text-white hover:bg-white hover:text-[#341C1C] transition-all duration-300 transform hover:scale-105">
